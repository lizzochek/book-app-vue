...
const changeBook = (book) => ({
  ...
  thumbnail: book.volumeInfo.imageLinks === undefined ? defaultImgUrl : `${book.volumeInfo.imageLinks.thumbnail}`,
  ...
  publishedDate: book.volumeInfo.publishedDate ? book.volumeInfo.publishedDate : 'No date available',
